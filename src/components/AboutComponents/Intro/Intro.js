...
const Intro = () => (
  <div className={styles.grid}>
    <p className={styles.para1}>
      ...
      awesome power of Gatsby, which lets me write React code, while you enjoy a
      blazing fast experience. Finally, the best of both worlds!
    </p>
    <p className={styles.para2}>
      ...
      recent JavaScript takeover. As long as it means a wonderful web to use and
      work in, I'll give it a go. I also enjoy tinkering with Adobe Illustrator
      and Photoshop.
    </p>
